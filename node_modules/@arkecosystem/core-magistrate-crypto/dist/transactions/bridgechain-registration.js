...
class BridgechainRegistrationTransaction extends crypto_1.Transactions.Transaction {
    ...
    serialize() {
        var _a;
        const { data } = this;
        core_kernel_1.Utils.assert.defined((_a = data.asset) === null || _a === void 0 ? void 0 : _a.bridgechainRegistration);
        ...
        let bridgechainAssetRepositoryBuffer = undefined;
    ...
    deserialize(buf) {
        ...
        let bridgechainAssetRepository = undefined;
...
BridgechainRegistrationTransaction.version = 2;
