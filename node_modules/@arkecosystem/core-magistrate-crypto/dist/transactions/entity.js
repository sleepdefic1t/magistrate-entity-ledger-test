...
class EntityTransaction extends crypto_1.Transactions.Transaction {
    ...
    static staticFee(feeContext = {}) {
        ...
        return ((_a = feeContext === null || feeContext === void 0 ? void 0 : feeContext.data) === null || _a === void 0 ? void 0 : _a.asset) ? this.staticFeeByAction[feeContext.data.asset.action] : this.defaultStaticFee;
    }
    serialize() {
        const { data } = this;
        core_kernel_1.Utils.assert.defined(data.asset);
