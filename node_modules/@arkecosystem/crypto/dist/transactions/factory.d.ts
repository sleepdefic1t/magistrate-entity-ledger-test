...
export declare class TransactionFactory {
    ...
    static fromBytes(buffer: Buffer, strict?: boolean, options?: IDeserializeOptions): ITransaction;
    /**
    ...
    static fromData(data: ITransactionData, strict?: boolean, options?: IDeserializeOptions): ITransaction;
