...
export declare type QueueOnDrainFunction = () => void;
export declare type QueueOnErrorFunction = (job: QueueJob, error: Error) => void;
export declare type QueueOnDataFunction = (job: QueueJob, data: any) => void;
/**
 * @export
 * @interface Queue
 */
