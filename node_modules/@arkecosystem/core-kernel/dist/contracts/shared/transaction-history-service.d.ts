...
import { Options, OrContainsCriteria, OrCriteria, OrEqualCriteria, OrLikeCriteria, OrNumericCriteria, Pagination, ResultsPage, Sorting } from "../search";
...
export interface TransactionHistoryService {
    ...
    listByCriteria(criteria: OrTransactionCriteria, sorting: Sorting, pagination: Pagination, options?: Options): Promise<ResultsPage<Interfaces.ITransactionData>>;
    ...
    listByCriteriaJoinBlock(criteria: OrTransactionCriteria, sorting: Sorting, pagination: Pagination, options?: Options): Promise<ResultsPage<TransactionDataWithBlockData>>;
}
