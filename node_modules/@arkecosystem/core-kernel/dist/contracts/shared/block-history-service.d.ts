...
export interface BlockHistoryService {
    ...
    listByCriteria(criteria: OrBlockCriteria, sorting: Sorting, pagination: Pagination, options?: Options): Promise<ResultsPage<Interfaces.IBlockData>>;
    ...
    listByCriteriaJoinTransactions(blockCriteria: OrBlockCriteria, transactionCriteria: OrTransactionCriteria, sorting: Sorting, pagination: Pagination, options?: Options): Promise<ResultsPage<BlockDataWithTransactionData>>;
}
