...
export interface ModelConverter {
    ...
    getBlockDataWithTransactionData(blockModels: BlockModel[], transactionModels: TransactionModel[]): BlockDataWithTransactionData[];
    ...
    getTransactionDataWithBlockData(transactionModels: TransactionModel[], blockModels: BlockModel[]): TransactionDataWithBlockData[];
}
