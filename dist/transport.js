...
exports.createARKTransport = void 0;
...
function createARKTransport() {
    return __awaiter(this, void 0, void 0, function* () {
        const transport = yield hw_transport_node_hid_1.default.create();
        return new ledger_transport_1.ARKTransport(transport);
    });
}
exports.createARKTransport = createARKTransport;
